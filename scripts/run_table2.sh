...
# Table 2: large-client natural-data results under FedScale trace latency.
TABLE="table2"
...
run_fedscale_setting femnist cnn 50 0.01
run_fedscale_setting gspeech melcnn 6 0.2
